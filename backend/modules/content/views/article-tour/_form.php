...
<div class="scnews-table-form">
    ...
    <?php echo $form->field($model, 'picture')->widget(FileInput::classname(), [
        ...
        'pluginOptions' => [
            ...
            'uploadUrl' => Url::to(['/content/article-tour/file-upload']),
        ],
        'pluginEvents' => [
            'fileuploaded' => 'function(event, key) { $(".field-scarticlestournaments-picture > input").val(key.response.name); }',
        ]
    ]); ?>
...
<?php $js = <<<JS
$(function(){
    $('input[name="SCArticlesTournaments[picture]"]').attr('value',$('#scarticlestournaments').attr('value'));
});
JS;
$this->registerJs($js);
?>
