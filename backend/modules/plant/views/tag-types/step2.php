    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="box box-solid">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Выберите товары для установки тега "<?=$tag?>" как атрибут</h3><br>
            ...
            <div class="box-body">
                <button type="button" id="checkAll" class="btn btn-warning btn-block">Выбрать все</button>

                <div class="cattreemain">
                    <ul class="catlist">
                        <?php foreach($model as $item):?>
                            <li data-cat="<?=$item->categoryID?>">
