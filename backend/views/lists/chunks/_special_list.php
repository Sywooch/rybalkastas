...
<?php foreach($list as $item):?>
    <input type="hidden" data-id="<?=$item->productID?>" name="resort[<?=$item->productID?>]" value="<?=$item->sort_order;?>" />
<?php endforeach;?>
    ...
    $(function(){
        $(".deletePrd").click(function(){
            if($(this).data("product")){
                $.ajax({
                    type: "POST",
                    url: "<?=\yii\helpers\Url::toRoute("lists/delete-specials")?>",
