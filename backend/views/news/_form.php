...
<div class="scnews-table-form">
    ...
    <?php echo $form->field($model, 'picture')->widget(FileInput::classname(), [
        ...
        'pluginEvents' => [
            'fileuploaded' => 'function(event, key) { $(".field-scnewstable-picture > input").val(key.response.name); }',
        ]
    ]); ?>
...
<?php $js = <<<JS
$(function(){
    $('input[name="SCNewsTable[picture]"]').attr('value',$('#scnewstable-picture').attr('value'));
});
JS;
$this->registerJs($js);
?>
