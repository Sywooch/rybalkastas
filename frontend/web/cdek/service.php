...
class ISDEKservice
{
    const ACCOUNT_FROM_INTEGRATION         = false;
    const SECURE_PASSWORD_FROM_INTEGRATION = false;

	// auth
	protected static $account = self::ACCOUNT_FROM_INTEGRATION; //укажите логин
	protected static $key     = self::SECURE_PASSWORD_FROM_INTEGRATION; //укажите ключ
