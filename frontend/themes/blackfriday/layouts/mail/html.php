                ...
                <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; width: 100%; margin: 0; padding: 0;">
                        ...
                        <td>
                            ...
                            <div>
                                <div style="margin-bottom: 0;list-style-type: none;text-align: justify;padding-left: 0">
                                    <span style="background:#ebecf0;font-weight:700;font-family:Arial;text-align:center;border-radius:7px;border-top-right-radius:7px;border:1px solid #ccc;border-bottom:none;display: table-cell;width: 1%;"><a style="color:#42598c;display:block;padding:12px 0 10px" href="<?=\yii\helpers\Url::base()?>/">Главная</a></span>
                                    <span style="background:#ebecf0;font-weight:700;font-family:Arial;text-align:center;border-radius:7px;border-top-right-radius:7px;border:1px solid #ccc;border-bottom:none;display: table-cell;width: 1%;"><a style="color:#42598c;display:block;padding:12px 0 10px" href="<?=\yii\helpers\Url::base()?>/page/o-nas">О компании</a></span>
                                    <span style="background:#ebecf0;font-weight:700;font-family:Arial;text-align:center;border-radius:7px;border-top-right-radius:7px;border:1px solid #ccc;border-bottom:none;display: table-cell;width: 1%;"><a style="color:#42598c;display:block;padding:12px 0 10px" href="<?=\yii\helpers\Url::base()?>/page/skidki-i-akcii">Скидки и акции</a></span>
                                    <span style="background:#ebecf0;font-weight:700;font-family:Arial;text-align:center;border-radius:7px;border-top-right-radius:7px;border:1px solid #ccc;border-bottom:none;display: table-cell;width: 1%;"><a style="color:#42598c;display:block;padding:12px 0 10px" href="<?=\yii\helpers\Url::base()?>/page/shops">Контакты</a></span>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
                        <td bgcolor="#fff" style="border-top:solid 2px #e93232; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6; margin: 0; padding: 0;">
                            ...
                            <p style="font-size:1em;text-align:center;color:#000;font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
                                © Rybalkashop.ru <?= date('Y') ?>.
                            </p>
                            <hr/>
                            <p style="text-align: center">
                                <a href="mailto:contacts@rybalkashop.ru">contacts@rybalkashop.ru</a><br/>
                                <strong>+ 7 (499) 707-11-14</strong><br/>
