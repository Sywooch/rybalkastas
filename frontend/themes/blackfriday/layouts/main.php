...
use frontend\assets\AppBFAsset;
...
\frontend\assets\BlackFridayAsset::register($this);
...
<div class="main-wrap">
        ...
        <div class="container top">
            ...
            <div class="row overflow_show">
                <div class="col-sm-5 col-md-5 col-xs-6 col-lg-6">
                    <strong class="logo"><a href="/"><img src="/img/logo_bf2.png?id=1" alt=""></a></strong>
                </div>
                ...
                <div class="col-sm-7 col-md-7 col-lg-6">
                    <div class="right-panel-header">
                        <div class="row overflow_show flex_center">
                            ...
                            <?=$this->renderDynamic('return Yii::$app->view->render(\'//_blocks/countdowns/days_until_black_friday\');');?>
        ...
        <div class="container">
            <div class="row">
                <div class="mobile-panel">
                    ...
                    <div class="basket"><a href="<?=Url::to(['/cart/index'])?>"><i class="fa fa-shopping-cart"></i> </a></div>
    ...
    <?php
    //echo $this->render('//_blocks/_revo_slider');
    ?>
