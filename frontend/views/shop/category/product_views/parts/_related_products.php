<?php
$related = \common\models\SCRelatedCategories::find()->select('relatedCategoryID')->where(['categoryID'=> $model->categoryID])->orderBy('RAND()')->all();
...
<div class="item-holder catalog-block box-rs">
    ...
    $models = \common\models\SCCategories::find()->where(['in','categoryID',$ids])->andWhere(['>','JSON_UNQUOTE(JSON_EXTRACT( meta_data, "$.countInStock"))', 0])->all();
    ?>
