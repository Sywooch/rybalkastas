<?php
$this->title = "Новости";
$this->params['breadcrumbs'][] = ['url'=>\yii\helpers\Url::to(['/news/index']),'label'=>"Новости"];
...
<div class="col-md-12">
    ...
    <a href="<?=\yii\helpers\Url::to(['/news/index'])?>" class="btn btn-primary pull-right">Вернуться</a>
</div>