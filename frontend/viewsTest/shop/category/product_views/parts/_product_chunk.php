...
<div data-title="<?= $this->title ?>" itemscope itemtype="http://schema.org/Product">
    <?= $this->render('_brandlink_mini', ['model' => $model->category]) ?>
    <h2 class="title" itemprop="name"><?= $model->name_ru ?></h2>
    <?php if (Yii::$app->user->can('contentField')): ?>
        <?= $this->render('admin/__product_toolbar', ['model' => $model]); ?>
    <?php endif; ?>
    <div class="rating">
        <div class="rat"></div>
    </div>
    ...
    <div class="row description-card-good">
        <div class="col-md-6 col-sm-5 col-xs-12">
            <?php if ($model->canAdd == 1): ?>
                ...
                $form = ActiveForm::begin([
                    ...
                    'options' => ['data-name' => $model->name_ru, 'class' => 'hidden-md hidden-lg']
                ]) ?>
                ...
                <button class="btn btn-primary btn-flat btn-block text-uppercase buybtn btn-rounded" type="submit"><i
                            class="fa fa-shopping-cart"
                            aria-hidden="true"></i> КУПИТЬ
                </button>
                <button class="btn btn-primary btn-flat btn-block buybtn" style="display: none" disabled="disabled"
        ...
        <div class="col-md-6 col-sm-7">
            <div class="right-information" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <?=$this->renderDynamic('return Yii::$app->view->render(\'//shop/category/product_views/parts/_dynamic/stock_string\');');?>
                ...
                <?=$this->renderDynamic('return Yii::$app->view->render(\'//shop/category/product_views/parts/_dynamic/price_buttons\');');?>

                <div class="scrollToDescription">
                    <a class="btn btn-flat btn-info nowrap"
                       href="#productDescription">Описание <?= $model->category->name_ru ?> <i
