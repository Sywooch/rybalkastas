    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div>
                    <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['/user/settings/orders']) ?>"><i
                            class="fa fa-chevron-left"></i> Назад</a>
                </div>
                ...
                <div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        foreach ($items as $item): ?>
                            <tr>
                                <td><?= $i; ?></td>
                                <td><a href="<?=\yii\helpers\Url::to(['/shop/category', 'id'=>$item->product->categoryID, 'product'=>$item->product->productID])?>"><?= $item->name; ?></a>
                                </td>
                                <td><?= $item->Quantity; ?></td>
