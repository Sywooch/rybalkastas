    ...
    <div class="brandpage">
        ...
        <div class="catalog-block">
            ...
            <div class="news-slider owl-carousel owl-theme">
                ...
                <div class="item">
                    <img src="<?= Yii::$app->imageman->load('/news_pictures/' . $n->image, null, 60, false, 'brandnews') ?>"/>
                    <div class="date"><i class="fa fa-calendar" aria-hidden="true"></i> <?=Yii::$app->formatter->asRelativeTime(strtotime($n->add_date))?></div>
                    <div class="caption">
