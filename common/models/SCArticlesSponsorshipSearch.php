...
/**
 * SCArticlesSponsorshipSearch represents the model behind the search form about `common\models\SCArticlesSponsorship`.
 * @property int $sort_order [int(11)]
 */
class SCArticlesSponsorshipSearch extends SCArticlesSponsorship
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = SCArticlesSponsorship::find();
