...
/**
 * This is the model class for table "SC_articles_tournaments".
 *
 * @property int $NID
 ...
 */
class SCArticlesTournaments extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'SC_articles_tournaments';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['add_stamp', 'priority', 'emailed', 'brand', 'published', 'sort_order'], 'integer'],
